...
case $1 in
	...
	19) mpc seek +1% > /dev/null 2>&1;;
        30) /home/pi/repository/PiSocketClient/src/socketClient 192.168.1.120 1 1 1;;
        31) /home/pi/repository/PiSocketClient/src/socketClient 192.168.1.120 255 255 255;;
        32) /home/pi/repository/PiSocketClient/src/socketClient 192.168.1.120 50 5 0;;
